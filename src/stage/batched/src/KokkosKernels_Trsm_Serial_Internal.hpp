  ...
  namespace Serial {
    ...
    struct TrsmInternalLeftLower {
      ...
      invoke(const bool use_unit_diag,
        ...
        //static_assert("KokkosKernels::TrsmInternalLeftLower:: Not yet implemented");
        return 0;
      }
    };
    ...
    invoke(const bool use_unit_diag,
      ...
      if (alpha == 0)   Util::set  (m, n, B, bs0, bs1, value_type(0)    );
      else {
        if (alpha != 1) Util::scale(m, n, B, bs0, bs1, value_type(alpha));
        if (m <= 0 || n <= 0) return 0;
    ...
    invoke(const bool use_unit_diag,
      ...
      if (alpha == 0) {
        /**/            Util::set  (m, n, B, bs0, bs1, value_type(0)    );
      } else {
        if (alpha != 1) Util::scale(m, n, B, bs0, bs1, value_type(alpha));
        if (m <= 0 || n <= 0) return 0;
