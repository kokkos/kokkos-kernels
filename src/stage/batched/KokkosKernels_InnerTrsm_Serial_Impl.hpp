...
// KOKKOS_INLINE_FUNCTION
// int
// InnerTrsmRightUpperNonUnitDiag<2>::
// invoke(const ValueType *__restrict__ A,
//        const int m,
//        /**/  ValueType *__restrict__ B) {
//   // X(m x n) U(n x n) = B (m x n)
...
// KOKKOS_INLINE_FUNCTION
// int
// InnerTrsmRightUpperNonUnitDiag<3>::
// invoke(const ValueType *__restrict__ A,
//        const int m,
//        /**/  ValueType *__restrict__ B) {
//   // X(m x n) U(n x n) = B (m x n)
...
// KOKKOS_INLINE_FUNCTION
// int
// InnerTrsmRightUpperNonUnitDiag<5>::
// invoke(const ValueType *__restrict__ A,
//        const int m,
//        /**/  ValueType *__restrict__ B) {
//   // X(m x n) U(n x n) = B (m x n)
