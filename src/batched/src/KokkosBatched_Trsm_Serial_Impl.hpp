...
namespace KokkosBatched {
  ...
  defined(__KOKKOSKERNELS_INTEL_MKL_COMPACT_BATCHED__)    
	...
	invoke(const ScalarType alpha,
	       const AViewType &A,
	       const BViewType &B) {
	  return TrsmInternalLeftLower<Algo::Trsm::Unblocked>::invoke(ArgDiag::use_unit_diag,
	...
	invoke(const ScalarType alpha,
	       const AViewType &A,
	       const BViewType &B) {
	  return TrsmInternalLeftLower<Algo::Trsm::Blocked>::invoke(ArgDiag::use_unit_diag,
								    B.dimension_0(), B.dimension_1(),
								    alpha, 
								    A.data(), A.stride_0(), A.stride_1(),
								    B.data(), B.stride_0(), B.stride_1());
  ...
  defined(__KOKKOSKERNELS_INTEL_MKL_COMPACT_BATCHED__)
	...
	invoke(const ScalarType alpha,
	       const AViewType &A,
	       const BViewType &B) {
	  return TrsmInternalLeftUpper<Algo::Trsm::Unblocked>::invoke(ArgDiag::use_unit_diag,
								      B.dimension_0(), B.dimension_1(),
								      alpha, 
								      A.data(), A.stride_0(), A.stride_1(),
								      B.data(), B.stride_0(), B.stride_1());
	...
	invoke(const ScalarType alpha,
	       const AViewType &A,
	       const BViewType &B) {
	  return TrsmInternalLeftUpper<Algo::Trsm::Blocked>::invoke(ArgDiag::use_unit_diag,
								    B.dimension_0(), B.dimension_1(),
								    alpha, 
								    A.data(), A.stride_0(), A.stride_1(),
								    B.data(), B.stride_0(), B.stride_1());
