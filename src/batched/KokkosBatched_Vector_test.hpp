...
namespace Kokkos {
  namespace Details {
    ...
    template<template<typename> class X, typename T, int l>
    class ArithTraits<Vector<X<T>,l> > { 
    public:
      typedef typename ArithTraits<T>::val_type val_scalar_type;
      typedef typename ArithTraits<T>::mag_type mag_scalar_type;

      typedef Vector<X<val_scalar_type>,l> val_type;
      typedef Vector<X<mag_scalar_type>,l> mag_type;
    ...
    template<template<typename> typename X, typename T, int l>
    class ArithTraits<Vector<X<Kokkos::complex<T>>,l> > {	
    public:
      typedef typename ArithTraits<T>::val_type val_scalar_type;
      typedef typename ArithTraits<T>::mag_type mag_scalar_type;

      typedef Vector<X<Kokkos::complex<val_scalar_type> >,l> val_type;
      typedef Vector<X<mag_scalar_type >,l> mag_type;
