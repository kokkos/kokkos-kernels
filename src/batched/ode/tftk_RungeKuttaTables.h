...
/*--------------------------------------------------------------------*/
#ifndef SIERRA_tftk_RungeKuttaTables_h
#define SIERRA_tftk_RungeKuttaTables_h
...
struct RK12 // Known as Fehlberg 1-2 method
{
  ...
  static constexpr int order = 2;
  Kokkos::Array<double, (n * n + n) / 2> a{{0.0, 0.5, 0.0, 1.0 / 256.0, 255.0 / 256.0, 0.0}};
...
struct BS // Bogacki-Shampine method
{
  ...
  Kokkos::Array<double, n> e{
      {2.0 / 9.0 - 7.0 / 24.0, 1.0 / 3.0 - 0.25, 4.0 / 9.0 - 1.0 / 3.0, -1.0 / 8.0}};
};
...
struct RKF45 // Fehlberg Method
{
  ...
  Kokkos::Array<double, n> e{{16.0 / 135.0 - 25.0 / 216.0,
      0.0,
...
struct CashKarp
{
  ...
  Kokkos::Array<double, n> e{{37.0 / 378.0 - 2825.0 / 27648.0,
      0.0,
...
struct DormandPrince // Referred to as DOPRI5
{
  ...
  Kokkos::Array<double, n> e{{35.0 / 384.0 - 5179.0 / 57600.0,
      0.0,
