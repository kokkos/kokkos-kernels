...
namespace KokkosBatched {
  namespace Experimental {
    ...
    template<typename T> KOKKOS_INLINE_FUNCTION typename Kokkos::Details::ArithTraits<T>::mag_type RealPart(const T &val) { return val; }
    template<typename T> KOKKOS_INLINE_FUNCTION typename Kokkos::Details::ArithTraits<Kokkos::complex<T> >::mag_type RealPart(const Kokkos::complex<T> &val) { return val.real(); }
    ...
    template<typename T> KOKKOS_INLINE_FUNCTION typename Kokkos::Details::ArithTraits<T>::mag_type ImagPart(const T &val) { return 0; }
    template<typename T> KOKKOS_INLINE_FUNCTION typename Kokkos::Details::ArithTraits<Kokkos::complex<T> >::mag_type ImagPart(const Kokkos::complex<T> &val) { return val.imag(); }
    template<typename T, int l> typename Kokkos::Details::ArithTraits<Vector<SIMD<Kokkos::complex<T> >,l> >::mag_type
