...
namespace KokkosBatched {
  namespace Experimental {
    ...
    public:
      ...
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_0() const { return _a.dimension_0()*(0 == PackDim::value ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_1() const { return _a.dimension_1()*(1 == PackDim::value ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_2() const { return _a.dimension_2()*(2 == PackDim::value ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_3() const { return _a.dimension_3()*(3 == PackDim::value ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_4() const { return _a.dimension_4()*(4 == PackDim::value ? vector_length : 1); }
