  ...
  namespace Experimental {
    ...
    public:
      ...
      enum : int { rank = ViewType::rank,
                   pack_dim = PackDim::value,
                   vector_length = value_simd_type::vector_length };
      ...
      { return _a.extent(r)*(r == pack_dim ? vector_length : 1); }
      ...
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_0() const { return _a.dimension_0()*(0 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_1() const { return _a.dimension_1()*(1 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_2() const { return _a.dimension_2()*(2 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_3() const { return _a.dimension_3()*(3 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_4() const { return _a.dimension_4()*(4 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_5() const { return _a.dimension_5()*(5 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_6() const { return _a.dimension_6()*(6 == pack_dim ? vector_length : 1); }
      KOKKOS_INLINE_FUNCTION constexpr size_t dimension_7() const { return _a.dimension_7()*(7 == pack_dim ? vector_length : 1); }
