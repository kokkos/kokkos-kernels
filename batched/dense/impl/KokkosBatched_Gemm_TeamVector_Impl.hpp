...
struct TeamVectorGemm<MemberType, Trans::NoTranspose, Trans::NoTranspose, ArgAlgo> {
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::Transpose, Trans::NoTranspose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::ConjTranspose, Trans::NoTranspose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_0 = Impl::get_extent_int(A, 0);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::NoTranspose, Trans::Transpose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_1 = Impl::get_extent_int(A, 1);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::Transpose, Trans::Transpose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_0 = Impl::get_extent_int(A, 0);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::ConjTranspose, Trans::Transpose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_0 = Impl::get_extent_int(A, 0);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::NoTranspose, Trans::ConjTranspose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_1 = Impl::get_extent_int(A, 1);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::Transpose, Trans::ConjTranspose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_0 = Impl::get_extent_int(A, 0);
...
template <typename MemberType, typename ArgAlgo>
struct TeamVectorGemm<MemberType, Trans::ConjTranspose, Trans::ConjTranspose, ArgAlgo> {
  template <typename ScalarType, typename AViewType, typename BViewType, typename CViewType>
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member, const ScalarType alpha, const AViewType &A,
                                           const BViewType &B, const ScalarType beta, const CViewType &C) {
    const int A_extent_0 = Impl::get_extent_int(A, 0);
