...
TEST_F( TestCategory, batched_scalar_batched_gemm_nt_nt_scomplex_scomplex_left ) {
  ...
  test_batched_gemm<TestExecSpace,Kokkos::complex<float>,Kokkos::complex<float>,param_tag_type>();
  test_batched_gemm<TestExecSpace,Kokkos::complex<float>,Kokkos::complex<float>,param_tag_type>();
}
...
TEST_F( TestCategory, batched_scalar_batched_gemm_nt_nt_dcomplex_dcomplex_left ) {
  ...
  test_batched_gemm<TestExecSpace,Kokkos::complex<double>,Kokkos::complex<double>,param_tag_type>();
  test_batched_gemm<TestExecSpace,Kokkos::complex<double>,Kokkos::complex<double>,param_tag_type>();
}
