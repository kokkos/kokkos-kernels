...
int test_batched_gemm() {
#if defined(KOKKOSKERNELS_INST_LAYOUTLEFT) 
  {
    ...
    for (int i=0;i<10;++i) {                                                                                        
      ...
      ((std::is_same<typename ParamTagType::transA,KokkosBatched::Experimental::Trans::NoTranspose>::value) &&
      ...
      ((std::is_same<typename ParamTagType::transA,KokkosBatched::Experimental::Trans::Transpose>::value) &&
        (std::is_same<typename ParamTagType::transB,KokkosBatched::Experimental::Trans::NoTranspose>::value)) {
