...
#if !defined(TEST_CUDA_BATCHED_DENSE_SERIAL_CPP) && !defined(TEST_CUDA_BATCHED_DENSE_TEAM_CPP) && !defined(TEST_CUDA_BATCHED_DENSE_TEAMVECTOR_CPP) && !defined(TEST_CUDA_BATCHED_DENSE_VECTOR_CPP) && \
