...
namespace TeamVectorSpmv {
  ...
  struct Functor_TestBatchedTeamVectorSpmv {
    ...
    void operator()(const ParamTagType &, const MemberType &member) const {
      ...
      KokkosBatched::TeamVectorSpmv<MemberType, typename ParamTagType::trans>::template invoke<DViewType, IntView, xViewType, yViewType, alphaViewType, betaViewType, dobeta> (member, alpha, d, _r, _c, x, beta, y);
    }
  ...
  void impl_test_batched_spmv(const int N, const int BlkSize, const int N_team) {
    ...
    Functor_TestBatchedTeamVectorSpmv<DeviceType,ParamTagType,DViewType,IntView,xViewType,yViewType,alphaViewType,betaViewType,dobeta>
