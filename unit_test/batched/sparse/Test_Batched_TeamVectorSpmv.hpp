...
namespace TeamVectorSpmv {
  ...
  struct Functor_TestBatchedTeamVectorSpmv {
    ...
    void operator()(const ParamTagType &, const MemberType &member) const {
      ...
      KokkosBatched::TeamVectorSpmv<MemberType, typename ParamTagType::trans>::template invoke<ValuesViewType, IntView, xViewType, yViewType, alphaViewType, betaViewType, dobeta> (member, alpha, d, _r, _c, x, beta, y);
    }
  ...
  void impl_test_batched_spmv(const int N, const int BlkSize, const int N_team) {
    ...
    Functor_TestBatchedTeamVectorSpmv<DeviceType,ParamTagType,ValuesViewType,IntView,xViewType,yViewType,alphaViewType,betaViewType,dobeta>
...
int test_batched_teamvector_spmv() {
#if defined(KOKKOSKERNELS_INST_LAYOUTLEFT) 
  {
    ...
    Test::TeamVectorSpmv::impl_test_batched_spmv<DeviceType,ParamTagType,ViewType,IntView,ViewType,ViewType,alphaViewType,alphaViewType,0>( 0, 10, 1);
    for (int i=3;i<10;++i) {                                                                                        
      Test::TeamVectorSpmv::impl_test_batched_spmv<DeviceType,ParamTagType,ViewType,IntView,ViewType,ViewType,alphaViewType,alphaViewType,0>(1024,  i, 2);
    }
    Test::TeamVectorSpmv::impl_test_batched_spmv<DeviceType,ParamTagType,ViewType,IntView,ViewType,ViewType,alphaViewType,alphaViewType,1>( 0, 10, 1);
    for (int i=3;i<10;++i) {                                                                                        
      Test::TeamVectorSpmv::impl_test_batched_spmv<DeviceType,ParamTagType,ViewType,IntView,ViewType,ViewType,alphaViewType,alphaViewType,1>(1024,  i, 2);
    }
  }
#endif
