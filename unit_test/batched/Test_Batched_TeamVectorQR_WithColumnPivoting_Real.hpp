...
TEST_F( TestCategory, batched_scalar_team_vector_qr_with_columnpivoting_float ) {
...
TEST_F( TestCategory, batched_scalar_team_vector_qr_with_columnpivoting_double ) {
  typedef Algo::QR::Unblocked algo_tag_type;
