...
int test_batched_gemv() {
#if defined(KOKKOSKERNELS_INST_LAYOUTLEFT) 
  {
    ...
    Test::impl_test_batched_gemv<DeviceType,ViewType,ScalarType,ParamTagType,AlgoTagType>(    10, 15);
    Test::impl_test_batched_gemv<DeviceType,ViewType,ScalarType,ParamTagType,AlgoTagType>(  1024,  9);
    Test::impl_test_batched_gemv<DeviceType,ViewType,ScalarType,ParamTagType,AlgoTagType>(132231,  3);
  }
#endif
...
TEST_F( TestCategory, batched_scalar_gemv_nt_float_float ) {
...
TEST_F( TestCategory, batched_scalar_gemv_t_float_float ) {
...
TEST_F( TestCategory, batched_scalar_gemv_nt_double_double ) {
  typedef ::Test::ParamTag<Trans::NoTranspose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,double,double,param_tag_type,algo_tag_type>();
}
TEST_F( TestCategory, batched_scalar_gemv_t_double_double ) {
  typedef ::Test::ParamTag<Trans::Transpose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,double,double,param_tag_type,algo_tag_type>();
}
...
TEST_F( TestCategory, batched_scalar_gemv_nt_dcomplex_dcomplex ) {
  typedef ::Test::ParamTag<Trans::NoTranspose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,Kokkos::complex<double>,Kokkos::complex<double>,param_tag_type,algo_tag_type>();
}
TEST_F( TestCategory, batched_scalar_gemv_t_dcomplex_dcomplex ) {
  typedef ::Test::ParamTag<Trans::Transpose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,Kokkos::complex<double>,Kokkos::complex<double>,param_tag_type,algo_tag_type>();
}
// TEST_F( TestCategory, batched_scalar_gemv_ct_dcomplex_dcomplex ) {
...
TEST_F( TestCategory, batched_scalar_gemv_nt_dcomplex_double ) {
  typedef ::Test::ParamTag<Trans::NoTranspose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,Kokkos::complex<double>,double,param_tag_type,algo_tag_type>();
}
TEST_F( TestCategory, batched_scalar_gemv_t_dcomplex_double ) {
  typedef ::Test::ParamTag<Trans::Transpose> param_tag_type;
  typedef Algo::Gemv::Blocked algo_tag_type;
  test_batched_gemv<TestExecSpace,Kokkos::complex<double>,double,param_tag_type,algo_tag_type>();
}
// TEST_F( TestCategory, batched_scalar_gemv_ct_dcomplex_double ) {
//   typedef ::Test::ParamTag<Trans::ConjTranspose> param_tag_type;
//   typedef Algo::Gemv::Blocked algo_tag_type;
//   test_batched_gemv<TestExecSpace,Kokkos::complex<double>,double,param_tag_type,algo_tag_type>();
// }
