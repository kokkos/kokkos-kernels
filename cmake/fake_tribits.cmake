...
MACRO(KOKKOSKERNELS_TARGET_COMPILE_OPTIONS TARGET)
IF(KOKKOSKERNELS_HAS_TRILINOS)
...
ELSE()
  TARGET_COMPILE_OPTIONS(${TARGET} ${ARGN})
ENDIF()
ENDMACRO(KOKKOSKERNELS_TARGET_COMPILE_OPTIONS)
...
FUNCTION(KOKKOSKERNELS_TARGET_INCLUDE_DIRECTORIES TARGET)
IF(KOKKOSKERNELS_HAS_TRILINOS)
...
ELSE()
  ...
  TARGET_INCLUDE_DIRECTORIES(${TARGET} ${INCTYPE} ${ARGN})
ENDIF()
ENDFUNCTION(KOKKOSKERNELS_TARGET_INCLUDE_DIRECTORIES TARGET)

FUNCTION(KOKKOSKERNELS_LINK_INTERNAL_LIBRARY TARGET DEPLIB)
IF(KOKKOSKERNELS_HAS_TRILINOS)
  #do nothing
ELSEIF(KOKKOS_SEPARATE_LIBS)
  ...
  ENDIF()
    ...
    VERIFY_EMPTY(KOKKOSKERNELS_LINK_INTERNAL_LIBRARY ${PARSE_UNPARSED_ARGUMENTS})
  ELSE()
    #only a single lib - so nothing to do here
ENDIF()
ENDFUNCTION(KOKKOSKERNELS_LINK_INTERNAL_LIBRARY)
...
FUNCTION(KOKKOSKERNELS_TARGET_COMPILE_DEFINITIONS TARGET)
IF(KOKKOSKERNELS_HAS_TRILINOS)
...
ELSE()
  TARGET_COMPILE_DEFINITIONS(${TARGET} ${ARGN})
ENDIF()
ENDFUNCTION(KOKKOSKERNELS_TARGET_COMPILE_DEFINITIONS)
