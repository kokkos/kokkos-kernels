...
# Function copied and refactored from kokkoskernels_features.cmake
function(trilinos_kokkoskernels_feature_depends_on_tpls FEATURE)
  IF (KOKKOSKERNELS_ENABLE_${FEATURE})
    FOREACH (TPL ${ARGN})
      IF (NOT TPL_ENABLE_${TPL})
        MESSAGE(SEND_ERROR "Feature ${FEATURE} requires TPL support for ${TPL}. Must build with -DTPL_ENABLE_${TPL}:BOOL=ON and potentially -D${TPL}_ROOT=<INSTALL> to the desired package location")
      ENDIF ()
    ENDFOREACH ()
  ENDIF ()
endfunction()