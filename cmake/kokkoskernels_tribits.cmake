...
IF (IS_ENABLED)
  ...
  ELSE()
    ...
    IF (PARSE_TESTONLYLIBS)
      TARGET_LINK_LIBRARIES(${EXE_NAME} PRIVATE common Kokkos::kokkoskernels ${PARSE_TESTONLYLIBS})
    ELSE ()
      TARGET_LINK_LIBRARIES(${EXE_NAME} PRIVATE common Kokkos::kokkoskernels)
    ENDIF()
  ENDIF()
ELSE()
