...
struct HostLapack {
  ...
  static void gesvd(const char jobu, const char jobvt, const int m, const int n, T *A, const int lda,
                    typename KokkosKernels::ArithTraits<T>::mag_type *S, T *U, const int ldu, T *Vt, const int ldvt, T *work,
                    int lwork, typename KokkosKernels::ArithTraits<T>::mag_type *rwork, int info);
