...
#define KOKKOSLAPACK_TRTRI_LAPACK_MAGMA(SCALAR_TYPE, BASE_SCALAR_TYPE, MAGMA_FN,   \
...
#define KOKKOSLAPACK_ZTRTRI_LAPACK(LAYOUTA, ETI_SPEC_AVAIL)                        \
  KOKKOSLAPACK_TRTRI_LAPACK_HOST(Kokkos::complex<double>, std::complex<double>,    \
                             LAYOUTA, Kokkos::HostSpace, ETI_SPEC_AVAIL)       \
  KOKKOSLAPACK_TRTRI_LAPACK_MAGMA(Kokkos::complex<double>, magmaDoubleComplex_ptr, \
...
#define KOKKOSLAPACK_CTRTRI_LAPACK(LAYOUTA, ETI_SPEC_AVAIL)                        \
  KOKKOSLAPACK_TRTRI_LAPACK_HOST(Kokkos::complex<float>, std::complex<float>,      \
                             LAYOUTA, Kokkos::HostSpace, ETI_SPEC_AVAIL)       \
  KOKKOSLAPACK_TRTRI_LAPACK_MAGMA(Kokkos::complex<float>, magmaFloatComplex_ptr,   \
