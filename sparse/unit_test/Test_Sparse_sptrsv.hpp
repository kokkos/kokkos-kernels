...
#if 0
  static void run_test_sptrsv_mtx() {
    // Lower tri
    std::cout << "LowerTriTest Begin" << std::endl;
    {
      ...
      Crs triMtx = KokkosKernels::Impl::read_kokkos_crst_matrix<crsmat_t>(mtx_filename.c_str()); //in_matrix
      crs_graph_t  lgraph  = triMtx.graph; // in_graph
