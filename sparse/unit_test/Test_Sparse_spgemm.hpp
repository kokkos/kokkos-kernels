...
int run_spgemm_old_interface(crsMat_t &A, crsMat_t &B, KokkosSparse::SPGEMMAlgorithm spgemm_algorithm, crsMat_t &result,
  ...
  kh.create_spgemm_handle(spgemm_algorithm);
  {
    ...
    KokkosSparse::spgemm_symbolic(&kh, num_rows_A, num_rows_B, num_cols_B, A.graph.row_map,
    ...
    KokkosSparse::spgemm_numeric(&kh, num_rows_A, num_rows_B, num_cols_B, A.graph.row_map,
