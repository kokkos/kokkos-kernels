...
#ifdef KOKKOS_ENABLE_DEPRECATED_CODE_5
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(5, 2);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(5, 4);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(5, 8);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(5, 16);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(9, 2);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(9, 4);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(9, 8);
  Test::run_test_extract_diagonal_blocks_rcb_deprecated<scalar_t, lno_t, size_type, device>(9, 16);
#endif
