...
#define KOKKOSSPARSE_SPTRSV_SOLVE_TPL_SPEC_AVAIL_CUSPARSE(SCALAR,	        \
                                                    LAYOUT, MEMSPACE)   \
  template <>								\
  struct sptrsv_solve_tpl_spec_avail <Kokkos::Cuda,			\
...
KOKKOSSPARSE_SPTRSV_SOLVE_TPL_SPEC_AVAIL_CUSPARSE(double, Kokkos::LayoutLeft, \
						  Kokkos::CudaSpace)
KOKKOSSPARSE_SPTRSV_SOLVE_TPL_SPEC_AVAIL_CUSPARSE(Kokkos::complex<float>, Kokkos::LayoutLeft, \
						  Kokkos::CudaSpace)
KOKKOSSPARSE_SPTRSV_SOLVE_TPL_SPEC_AVAIL_CUSPARSE(Kokkos::complex<double>, Kokkos::LayoutLeft, \
						  Kokkos::CudaSpace)
