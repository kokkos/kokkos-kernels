...
struct IlutWrap {
  ...
  static void multiply_matrices(KHandle& kh, IlutHandle& ih, const LRowMapType& L_row_map,
    ...
    KokkosSparse::spgemm_symbolic(&kh, nrows, nrows, nrows, L_row_map, L_entries, false, U_row_map,
    ...
    KokkosSparse::spgemm_numeric(&kh, nrows, nrows, nrows, L_row_map, L_entries, L_values, false,
