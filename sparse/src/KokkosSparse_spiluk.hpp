...
void spiluk_numeric_streams(const std::vector<ExecutionSpace>& execspace_v,
                            const std::vector<KernelHandle*>& handle_v,
                            typename KernelHandle::const_nnz_lno_t fill_lev,
                            const std::vector<ARowMapType>& A_rowmap_v,
  ...
  static_assert(Kokkos::is_view<AEntriesType>::value,
                "spiluk_numeric_streams: A_entries is not a Kokkos::View.");
  static_assert(Kokkos::is_view<AValuesType>::value,
                "spiluk_numeric_streams: A_values is not a Kokkos::View.");
  static_assert(Kokkos::is_view<LRowMapType>::value,
                "spiluk_numeric_streams: L_rowmap is not a Kokkos::View.");
  static_assert(Kokkos::is_view<LEntriesType>::value,
                "spiluk_numeric_streams: L_entries is not a Kokkos::View.");
  static_assert(Kokkos::is_view<LValuesType>::value,
                "spiluk_numeric_streams: L_values is not a Kokkos::View.");
  static_assert(Kokkos::is_view<URowMapType>::value,
                "spiluk_numeric_streams: U_rowmap is not a Kokkos::View.");
  static_assert(Kokkos::is_view<UEntriesType>::value,
                "spiluk_numeric_streams: U_entries is not a Kokkos::View.");
  static_assert(Kokkos::is_view<UValuesType>::value,
