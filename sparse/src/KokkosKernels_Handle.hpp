...
class KokkosKernelsHandle {
 ...
 public:
   ...
   *
   * @param handle_exec_space The execution space instance to execute kernels
   * on.
   ...
   * graph with: KokkosGraph::COLORING_DEFAULT  ?? KokkosGraph::COLORING_SERIAL
   * Serial Greedy Coloring KokkosGraph::COLORING_VB       Vertex Based Coloring
   ...
   *   KokkosGraph::COLORING_VBDBIT   Vertex Based Deterministic Coloring with
   * bit array KokkosGraph::COLORING_EB       Edge Based Coloring
   *   KokkosGraph::COLORING_SERIAL2  Serial Distance-2 Graph Coloring (kept
   * here for backwards compatibility for SPGEMM and other use cases)
   */
