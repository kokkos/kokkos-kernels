...
template <typename crsMat_t>
void sort_crs_matrix(const crsMat_t& A, SortAlgorithm option = SortAlgorithm::DEFAULT) {
...
template <typename crsMat_t>
crsMat_t sort_and_merge_matrix(const crsMat_t& A, SortAlgorithm option = SortAlgorithm::DEFAULT) {
