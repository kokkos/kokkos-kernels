...
#define KOKKOSSPARSE_CUSPARSE_SAFE_CALL(call)                                                                    \
...
#else
#define KOKKOSSPARSE_CUSPARSE_SAFE_CALL(call) KOKKOSPARSE_IMPL_CUSPARSE_SAFE_CALL(call)  // no good way to deprecate?
#endif
