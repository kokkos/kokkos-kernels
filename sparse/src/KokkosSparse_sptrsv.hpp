...
template <class ExecutionSpace, typename KernelHandle, typename lno_row_view_t_, typename lno_nnz_view_t_, typename scalar_nnz_view_t_, class BType, class XType>
void sptrsv_solve_streams(const std::vector<ExecutionSpace>& execspace_v,
                          const std::vector<KernelHandle*>& handle_v,
                          const std::vector<lno_row_view_t_>& rowmap_v,
                          const std::vector<lno_nnz_view_t_>& entries_v,
                          const std::vector<scalar_nnz_view_t_>& values_v,
  ...
  static_assert(Kokkos::SpaceAccessibility<ExecutionSpace, typename lno_row_view_t_::memory_space>::accessible, "sptrsv_solve_streams: ExecutionSpace cannot access data in lno_row_view_t_");
  static_assert(Kokkos::SpaceAccessibility<ExecutionSpace, typename lno_nnz_view_t_::memory_space>::accessible, "sptrsv_solve_streams: ExecutionSpace cannot access data in lno_nnz_view_t_");
  static_assert(Kokkos::SpaceAccessibility<ExecutionSpace, typename scalar_nnz_view_t_::memory_space>::accessible, "sptrsv_solve_streams: ExecutionSpace cannot access data in scalar_nnz_view_t_");
  static_assert(Kokkos::SpaceAccessibility<ExecutionSpace, typename BType::memory_space>::accessible, "sptrsv_solve_streams: ExecutionSpace cannot access data in BType");
  static_assert(Kokkos::SpaceAccessibility<ExecutionSpace, typename XType::memory_space>::accessible, "sptrsv_solve_streams: ExecutionSpace cannot access data in XType");

  static_assert(KOKKOSKERNELS_SPTRSV_SAME_TYPE(typename lno_row_view_t_::non_const_value_type, size_type), "sptrsv_solve_streams: A size_type must match KernelHandle size_type (const doesn't matter)");
  static_assert(KOKKOSKERNELS_SPTRSV_SAME_TYPE(typename lno_nnz_view_t_::non_const_value_type, ordinal_type), "sptrsv_solve_streams: A entry type must match KernelHandle entry type (aka nnz_lno_t, and const doesn't matter)");
  static_assert(KOKKOSKERNELS_SPTRSV_SAME_TYPE(typename scalar_nnz_view_t_::value_type, scalar_type), "sptrsv_solve_streams: A scalar type must match KernelHandle entry type (aka nnz_lno_t, and const doesn't matter)");
  ...
  static_assert(std::is_same<typename XType::value_type, typename XType::non_const_value_type>::value, "sptrsv_solve_streams: The output x must be nonconst.");
  static_assert(std::is_same<typename BType::device_type, typename XType::device_type>::value, "sptrsv_solve_streams: Views BType and XType have different device_types.");
  static_assert(std::is_same<ExecutionSpace, typename KernelHandle::SPTRSVHandleType::execution_space>::value, "sptrsv_solve_streams: KernelHandle's execution space is different from ExecutionSpace.");
  static_assert(std::is_same<typename BType::device_type::execution_space, typename KernelHandle::SPTRSVHandleType::execution_space>::value, "sptrsv_solve_streams: KernelHandle and Views have different execution spaces.");
  static_assert(std::is_same<typename lno_row_view_t_::device_type, typename lno_nnz_view_t_::device_type>::value, "sptrsv_solve_streams: rowmap and entries have different device types.");
  static_assert(std::is_same<typename lno_row_view_t_::device_type, typename scalar_nnz_view_t_::device_type>::value, "sptrsv_solve_streams: rowmap and values have different device types.");
  ...
  using BType_Internal = Kokkos::View<
      typename BType::const_value_type *,
      typename KokkosKernels::Impl::GetUnifiedLayout<BType>::array_layout,
      typename BType::device_type,
      Kokkos::MemoryTraits<Kokkos::Unmanaged | Kokkos::RandomAccess> >;

  using XType_Internal = Kokkos::View<
      typename XType::non_const_value_type *,
      typename KokkosKernels::Impl::GetUnifiedLayout<XType>::array_layout,
      typename XType::device_type, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;
