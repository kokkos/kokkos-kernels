...
bool gemv_based_gemm(
    const execution_space& space, const char transA[],
...
void gemm(const execution_space& space, const char transA[],
  ...
  static_assert(Kokkos::is_execution_space_v<execution_space>,
		"KokkosBlas::gemm: execution_space must be a valid Kokkos execution space");
  ...
  static_assert(Kokkos::SpaceAccessibility<typename CViewType::memory_space, typename AViewType::memory_space>::assignable,
		"KokkosBlas::gemm: CViewType must be assignable by AViewType");
  static_assert(Kokkos::SpaceAccessibility<typename CViewType::memory_space, typename BViewType::memory_space>::assignable,
