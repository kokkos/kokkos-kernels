...
void gemm(const execution_space& space, const char transA[], const char transB[],
  ...
  // parameters.
  typedef Kokkos::View<typename AViewType::const_value_type**, typename AViewType::array_layout, execution_space,
                       Kokkos::MemoryTraits<Kokkos::Unmanaged>>
      AVT;
  typedef Kokkos::View<typename BViewType::const_value_type**, typename BViewType::array_layout, execution_space,
                       Kokkos::MemoryTraits<Kokkos::Unmanaged>>
      BVT;
  typedef Kokkos::View<typename CViewType::non_const_value_type**, typename CViewType::array_layout, execution_space,
                       Kokkos::MemoryTraits<Kokkos::Unmanaged>>
      CVT;
