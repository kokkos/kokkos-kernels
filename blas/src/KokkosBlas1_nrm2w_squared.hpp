...
nrm2w_squared(const execution_space& space, const XVector& x, const XVector& w) {
  ...
  static_assert(Kokkos::SpaceAccessibility<execution_space, typename XVector::memory_space>::accessible,
		"KokkosBlas::nrm2w_squared: XVector must be accessible from execution_space.");
...
void nrm2w_squared(
  ...
  // rank 1 or rank 2.
  using RV_Internal = Kokkos::View<typename RV::non_const_data_type, UnifiedRVLayout,
