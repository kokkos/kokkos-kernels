...
typename KokkosKernels::Details::InnerProductSpaceTraits<typename XVector::non_const_value_type>::mag_type nrm2w_squared(
...
void nrm2w_squared(const execution_space& space, const RV& R, const XMV& X, const XMV& W,
  ...
  using mag_type = typename KokkosKernels::Details::InnerProductSpaceTraits<typename XMV::non_const_value_type>::mag_type;
