...
struct Functor_TestBatchedThreadVector {
  ViewTypeA _a;
  ViewTypeB _b;
  ViewTypeC _c;
  ...
  Functor_TestBatchedThreadVector(const ScalarType alpha, const ViewTypeA &a,
  ...
  KOKKOS_INLINE_FUNCTION void operator()(const ParamTagType &,
    ...
    KokkosBlas::ThreadVectorGemm<typename ParamTagType::transA,
  ...
  inline void run() {
    ...
    std::string name_region("KokkosBatched::Test::ThreadVector");
...
template <typename DeviceType, typename ViewTypeA, typename ViewTypeB,
          typename ViewTypeC, typename ScalarType, typename ParamTagType,
          typename AlgoTagType>
void impl_test_batched_threadvectorgemm(const int N, const int dimM,
                                        const int dimN, const int dimK) {
  ...
  // Functor_TestBatchedThreadVector<DeviceType,ViewType,ScalarType,
  ...
  Functor_TestBatchedThreadVector<DeviceType, ViewTypeA, ViewTypeB, ViewTypeC,
...
test_batched_threadvectorgemm() {
  // skip algorithms not supported by ThreadVectorGemm
  return 0;
}
...
test_batched_threadvectorgemm() {
#if defined(KOKKOSKERNELS_INST_LAYOUTLEFT)
  {
    ...
    typedef Kokkos::View<ValueTypeC ***, Kokkos::LayoutLeft, DeviceType>
        ViewTypeC;
    impl_test_batched_threadvectorgemm<DeviceType, ViewTypeA, ViewTypeB,
...
#define TEST_THREADVECTOR_CASE2(NAME, VALUE, SCALAR)                        \
  TEST_GEMM_CASE(thread_vector, NAME, test_batched_threadvectorgemm, VALUE, \
                 VALUE, VALUE, SCALAR)
#define TEST_THREADVECTOR_CASE(NAME, VALUE) \
  TEST_THREADVECTOR_CASE2(NAME, VALUE, VALUE)

#if defined(KOKKOS_BHALF_T_IS_FLOAT)
TEST_THREADVECTOR_CASE(bhalf_bhalf, ::Test::bhalfScalarType)
#endif

#if defined(KOKKOS_HALF_T_IS_FLOAT)
TEST_THREADVECTOR_CASE(half_half, ::Test::halfScalarType)
#endif

#if defined(KOKKOSKERNELS_INST_FLOAT)
TEST_THREADVECTOR_CASE(float_float, float)
#endif

#if defined(KOKKOSKERNELS_INST_DOUBLE)
TEST_THREADVECTOR_CASE(double_double, double)
#endif

#if defined(KOKKOSKERNELS_INST_COMPLEX_DOUBLE)
TEST_THREADVECTOR_CASE(dcomplex_dcomplex, Kokkos::complex<double>)
TEST_THREADVECTOR_CASE2(dcomplex_double, Kokkos::complex<double>, double)
#endif

#if defined(KOKKOSKERNELS_INST_COMPLEX_FLOAT)
TEST_THREADVECTOR_CASE(fcomplex_fcomplex, Kokkos::complex<float>)
TEST_THREADVECTOR_CASE2(fcomplex_float, Kokkos::complex<float>, float)
#endif

#if defined(KOKKOSKERNELS_INST_FLOAT) && defined(KOKKOSKERNELS_INST_DOUBLE)
TEST_GEMM_CASE(thread_vector, mixed_scalars, test_batched_threadvectorgemm,
