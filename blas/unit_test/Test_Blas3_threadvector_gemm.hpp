...
struct Functor_TestBatchedThreadVector {
  ...
  Functor_TestBatchedThreadVector(const ScalarType alpha, const ViewType &a,
...
test_batched_threadvectorgemm() {
#if defined(KOKKOSKERNELS_INST_LAYOUTLEFT)
  {
    typedef Kokkos::View<ValueType ***, Kokkos::LayoutLeft, DeviceType>
        ViewType;
    impl_test_batched_threadvectorgemm<DeviceType, ViewType, ScalarType,
                                       ParamTagType, AlgoTagType>(0, 10, 10,
                                                                  10);
    for (int i = 0; i < 10; ++i) {
