...
#define KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(EXEC_SPACE, LAYOUT, ETI_SPEC_AVAIL)                                     \
  template <>                                                                                                        \
  struct Nrm2<EXEC_SPACE, Kokkos::View<double, LAYOUT, Kokkos::HostSpace, Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
    ...
    typedef typename XV::size_type size_type;                                                                        \
                                                                                                                     \
    static void nrm2(const EXEC_SPACE& space, RV& R, const XV& X, const bool& take_sqrt) {                           \
      ...
      if (numElems < static_cast<size_type>(INT_MAX)) {                                                              \
        ...
        Nrm2<EXEC_SPACE, RV, XV, 1, false, ETI_SPEC_AVAIL>::nrm2(space, R, X, take_sqrt);                            \
      }                                                                                                              \
      Kokkos::Profiling::popRegion();                                                                                \
    }                                                                                                                \
  };

#define KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(EXEC_SPACE, LAYOUT, ETI_SPEC_AVAIL)                                    \
  template <>                                                                                                       \
  struct Nrm2<EXEC_SPACE, Kokkos::View<float, LAYOUT, Kokkos::HostSpace, Kokkos::MemoryTraits<Kokkos::Unmanaged> >, \
...
#define KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(EXEC_SPACE, LAYOUT, ETI_SPEC_AVAIL)                                        \
  template <>                                                                                                           \
  struct Nrm2<                                                                                                          \
...
#define KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(EXEC_SPACE, LAYOUT, ETI_SPEC_AVAIL)                                      \
  template <>                                                                                                         \
  struct Nrm2<                                                                                                        \
...
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Serial, Kokkos::LayoutLeft, false)
#endif
#ifdef KOKKOS_ENABLE_OPENMP
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::OpenMP, Kokkos::LayoutLeft, false)
#endif
#ifdef KOKKOS_ENABLE_THREADS
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_DNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_SNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_ZNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, false)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, true)
KOKKOSBLAS1_CNRM2_TPL_SPEC_DECL_BLAS(Kokkos::Threads, Kokkos::LayoutLeft, false)
#endif
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS(LAYOUT, KOKKOS_TYPE, TPL_TYPE, EXECSPACE, TPL_NRM2, ETI_SPEC_AVAIL)      \
  template <>                                                                                                          \
  struct Nrm2<EXECSPACE,                                                                                               \
              Kokkos::View<KokkosKernels::ArithTraits<KOKKOS_TYPE>::mag_type, LAYOUT, Kokkos::HostSpace,               \
                           Kokkos::MemoryTraits<Kokkos::Unmanaged> >,                                                  \
              Kokkos::View<const KOKKOS_TYPE*, LAYOUT, EXECSPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >, 1, true,  \
              ETI_SPEC_AVAIL> {                                                                                        \
    ...
    using XV        = Kokkos::View<const KOKKOS_TYPE*, LAYOUT, EXECSPACE, Kokkos::MemoryTraits<Kokkos::Unmanaged> >;   \
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS_EXT(ETI_SPEC_AVAIL)                                                      \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS(Kokkos::LayoutLeft, float, float, Kokkos::Cuda, cublasSnrm2, ETI_SPEC_AVAIL)   \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS(Kokkos::LayoutLeft, double, double, Kokkos::Cuda, cublasDnrm2, ETI_SPEC_AVAIL) \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS(Kokkos::LayoutLeft, Kokkos::complex<float>, cuComplex, Kokkos::Cuda,           \
                                        cublasScnrm2, ETI_SPEC_AVAIL)                                                  \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_CUBLAS(Kokkos::LayoutLeft, Kokkos::complex<double>, cuDoubleComplex, Kokkos::Cuda,    \
                                        cublasDznrm2, ETI_SPEC_AVAIL)
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS(LAYOUT, KOKKOS_TYPE, TPL_TYPE, EXECSPACE, TPL_NRM2, ETI_SPEC_AVAIL)    \
  template <>                                                                                                         \
  struct Nrm2<EXECSPACE,                                                                                              \
              Kokkos::View<KokkosKernels::ArithTraits<KOKKOS_TYPE>::mag_type, LAYOUT, Kokkos::HostSpace,              \
                           Kokkos::MemoryTraits<Kokkos::Unmanaged> >,                                                 \
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS_EXT(ETI_SPEC_AVAIL)                                                     \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS(Kokkos::LayoutLeft, float, float, Kokkos::HIP, rocblas_snrm2, ETI_SPEC_AVAIL) \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS(Kokkos::LayoutLeft, double, double, Kokkos::HIP, rocblas_dnrm2,               \
                                         ETI_SPEC_AVAIL)                                                               \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS(Kokkos::LayoutLeft, Kokkos::complex<float>, rocblas_float_complex,            \
                                         Kokkos::HIP, rocblas_scnrm2, ETI_SPEC_AVAIL)                                  \
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ROCBLAS(Kokkos::LayoutLeft, Kokkos::complex<double>, rocblas_double_complex,          \
                                         Kokkos::HIP, rocblas_dznrm2, ETI_SPEC_AVAIL)
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ONEMKL(LAYOUT, KOKKOS_TYPE, TPL_TYPE, EXECSPACE, TPL_NRM2, ETI_SPEC_AVAIL)      \
  template <>                                                                                                          \
  struct Nrm2<EXECSPACE,                                                                                               \
              Kokkos::View<KokkosKernels::ArithTraits<KOKKOS_TYPE>::mag_type, LAYOUT, Kokkos::HostSpace,               \
                           Kokkos::MemoryTraits<Kokkos::Unmanaged> >,                                                  \
...
#define KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ONEMKL_EXT(ETI_SPEC_AVAIL)                                                      \
  ...
  KOKKOSBLAS1_NRM2_TPL_SPEC_DECL_ONEMKL(Kokkos::LayoutLeft, Kokkos::complex<double>, std::complex<double>,             \
                                        Kokkos::SYCL, oneapi::mkl::blas::row_major::nrm2, ETI_SPEC_AVAIL)
