...
#define KOKKOSBLAS2_DGER_ROCBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,             \
                                 ETI_SPEC_AVAIL)                            \
  template <>                                                               \
  struct GER<                                                               \
      EXEC_SPACE,                                                           \
...
#define KOKKOSBLAS2_SGER_ROCBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,             \
                                 ETI_SPEC_AVAIL)                            \
  template <>                                                               \
  struct GER<                                                               \
      EXEC_SPACE,                                                           \
...
#define KOKKOSBLAS2_ZGER_ROCBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,               \
                                 ETI_SPEC_AVAIL)                              \
  template <>                                                                 \
...
#define KOKKOSBLAS2_CGER_ROCBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,              \
                                 ETI_SPEC_AVAIL)                             \
  template <>                                                                \
  struct GER<EXEC_SPACE,                                                     \
