...
void F77_BLAS_MANGLE(cgeru, CGERU)( int*
                                  , int*
                                  , const std::complex<float>*
                                  , const std::complex<float>*
                                  , int*
...
void F77_BLAS_MANGLE(cgerc, CGERC)( int*
                                  , int*
                                  , const std::complex<float>*
                                  , const std::complex<float>*
                                  , int*
...
void F77_BLAS_MANGLE(zgeru, ZGERU)( int*
                                  , int*
                                  , const std::complex<double>*
                                  , const std::complex<double>*
                                  , int*
...
void F77_BLAS_MANGLE(zgerc, ZGERC)( int*
                                  , int*
                                  , const std::complex<double>*
                                  , const std::complex<double>*
                                  , int*
...
template <>
void HostBlas<std::complex<float> >::geru( int m
                                         , int n
                                         , const std::complex<float> alpha
                                         , const std::complex<float>* x
                                         , int incx
...
template <>
void HostBlas<std::complex<float> >::gerc( int m
                                         , int n
                                         , const std::complex<float> alpha
                                         , const std::complex<float>* x
                                         , int incx
...
template <>
void HostBlas<std::complex<double> >::geru( int m
                                          , int n
                                          , const std::complex<double> alpha
                                          , const std::complex<double>* x
                                          , int incx
...
template <>
void HostBlas<std::complex<double> >::gerc( int m
                                          , int n
                                          , const std::complex<double> alpha
                                          , const std::complex<double>* x
                                          , int incx
