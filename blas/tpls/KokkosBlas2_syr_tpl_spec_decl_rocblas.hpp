...
#define KOKKOSBLAS2_DSYR_ROCBLAS(LAYOUT, EXEC_SPACE, ETI_SPEC_AVAIL)                                                  \
  template <>                                                                                                         \
...
#define KOKKOSBLAS2_SSYR_ROCBLAS(LAYOUT, EXEC_SPACE, ETI_SPEC_AVAIL)                                                  \
  template <>                                                                                                         \
...
#define KOKKOSBLAS2_ZSYR_ROCBLAS(LAYOUT, EXEC_SPACE, ETI_SPEC_AVAIL)                                               \
  template <>                                                                                                      \
  struct SYR<                                                                                                      \
      EXEC_SPACE,                                                                                                  \
      ...
      if (justTranspose) {                                                                                         \
        if (A_is_ll) {                                                                                             \
          ...
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(                                                                       \
              rocblas_zsyr(s.handle, fillMode, N, reinterpret_cast<const rocblas_double_complex*>(&alpha),         \
        ...
        if (A_is_ll && (alpha.imag() == 0.)) {                                                                     \
          ...
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_stream(s.handle, space.hip_stream()));                     \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_pointer_mode(s.handle, rocblas_pointer_mode_host));        \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_zher(                                                          \
              s.handle, fillMode, N, &alpha_val, reinterpret_cast<const rocblas_double_complex*>(X.data()), one,   \
              reinterpret_cast<rocblas_double_complex*>(A.data()), LDA));                                          \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_stream(s.handle, NULL));                                   \
        } else {                                                                                                   \
...
#define KOKKOSBLAS2_CSYR_ROCBLAS(LAYOUT, EXEC_SPACE, ETI_SPEC_AVAIL)                                              \
  template <>                                                                                                     \
  struct SYR<                                                                                                     \
      EXEC_SPACE,                                                                                                 \
    ...
    static void syr(const typename AViewType::execution_space& space, const char trans[], const char uplo[],      \
      ...
      if (justTranspose) {                                                                                        \
        if (A_is_ll) {                                                                                            \
          ...
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_pointer_mode(s.handle, rocblas_pointer_mode_host));       \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(                                                                      \
              rocblas_csyr(s.handle, fillMode, N, reinterpret_cast<const rocblas_float_complex*>(&alpha),         \
        ...
        if (A_is_ll && (alpha.imag() == 0.)) {                                                                    \
          ...
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_stream(s.handle, space.hip_stream()));                    \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_pointer_mode(s.handle, rocblas_pointer_mode_host));       \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_cher(                                                         \
              s.handle, fillMode, N, &alpha_val, reinterpret_cast<const rocblas_float_complex*>(X.data()), one,   \
              reinterpret_cast<rocblas_float_complex*>(A.data()), LDA));                                          \
          KOKKOSBLAS_IMPL_ROCBLAS_SAFE_CALL(rocblas_set_stream(s.handle, NULL));                                  \
        } else {                                                                                                  \
...
KOKKOSBLAS2_DSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, true)
KOKKOSBLAS2_DSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, false)
KOKKOSBLAS2_DSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, true)
KOKKOSBLAS2_DSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, false)

KOKKOSBLAS2_SSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, true)
KOKKOSBLAS2_SSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, false)
KOKKOSBLAS2_SSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, true)
KOKKOSBLAS2_SSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, false)

KOKKOSBLAS2_ZSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, true)
KOKKOSBLAS2_ZSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, false)
KOKKOSBLAS2_ZSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, true)
KOKKOSBLAS2_ZSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, false)

KOKKOSBLAS2_CSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, true)
KOKKOSBLAS2_CSYR_ROCBLAS(Kokkos::LayoutLeft, Kokkos::HIP, false)
KOKKOSBLAS2_CSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, true)
KOKKOSBLAS2_CSYR_ROCBLAS(Kokkos::LayoutRight, Kokkos::HIP, false)
