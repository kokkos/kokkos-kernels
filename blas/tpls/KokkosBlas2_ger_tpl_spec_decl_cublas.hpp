...
#define KOKKOSBLAS2_DGER_CUBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,                \
                                ETI_SPEC_AVAIL)                               \
  template <>                                                                 \
  struct GER<                                                                 \
      EXEC_SPACE,                                                             \
...
#define KOKKOSBLAS2_SGER_CUBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,                \
                                ETI_SPEC_AVAIL)                               \
  template <>                                                                 \
  struct GER<                                                                 \
      EXEC_SPACE,                                                             \
...
#define KOKKOSBLAS2_ZGER_CUBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,         \
                                ETI_SPEC_AVAIL)                        \
  template <>                                                          \
...
#define KOKKOSBLAS2_CGER_CUBLAS(LAYOUT, EXEC_SPACE, MEM_SPACE,            \
                                ETI_SPEC_AVAIL)                           \
  template <>                                                             \
  struct GER<EXEC_SPACE,                                                  \
...
KOKKOSBLAS2_DGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_DGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
KOKKOSBLAS2_DGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_DGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
...
KOKKOSBLAS2_SGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_SGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
KOKKOSBLAS2_SGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_SGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
...
KOKKOSBLAS2_ZGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_ZGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
KOKKOSBLAS2_ZGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_ZGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
...
KOKKOSBLAS2_CGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_CGER_CUBLAS(Kokkos::LayoutLeft, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
KOKKOSBLAS2_CGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, true)
KOKKOSBLAS2_CGER_CUBLAS(Kokkos::LayoutRight, Kokkos::Cuda,
                        Kokkos::CudaSpace, false)
