...
#define KOKKOSBLAS3_GEMM_TPL_SPEC_AVAIL_BLAS(SCALAR, LAYOUTA, LAYOUTB, LAYOUTC)                              \
  ...
  struct gemm_tpl_spec_avail<                                                                                \
      ...
      Kokkos::View<const SCALAR**, LAYOUTB, ExecSpace, Kokkos::MemoryTraits<Kokkos::Unmanaged> >,            \
      Kokkos::View<SCALAR**, LAYOUTC, ExecSpace, Kokkos::MemoryTraits<Kokkos::Unmanaged> > > {               \
