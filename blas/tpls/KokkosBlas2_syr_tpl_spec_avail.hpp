...
#define KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(SCALAR, LAYOUT)                            \
  template <>                                                                             \
  struct syr_tpl_spec_avail< Kokkos::View< const SCALAR*                                  \
                                         , LAYOUT                                         \
...
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(double,                  Kokkos::LayoutLeft)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(float,                   Kokkos::LayoutLeft)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(Kokkos::complex<double>, Kokkos::LayoutLeft)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(Kokkos::complex<float>,  Kokkos::LayoutLeft)

KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(double,                  Kokkos::LayoutRight)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(float,                   Kokkos::LayoutRight)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(Kokkos::complex<double>, Kokkos::LayoutRight)
KOKKOSBLAS2_SYR_TPL_SPEC_AVAIL_ROCBLAS(Kokkos::complex<float> , Kokkos::LayoutRight)
