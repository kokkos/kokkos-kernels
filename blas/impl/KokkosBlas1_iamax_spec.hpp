...
// Windows 64-bit: size_t == unsigned long long (not unsigned long, which is 32-bit on Windows).
// The helpers below add ETI coverage for the extra Windows index type; they are no-ops elsewhere.
#ifdef _WIN64
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_AVAIL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
    KOKKOSBLAS1_IAMAX_ETI_SPEC_AVAIL_INDEX(unsigned long long, SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_AVAIL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
  KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_AVAIL_INDEX_HOST(unsigned long long, SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_DECL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
  KOKKOSBLAS1_IAMAX_ETI_SPEC_DECL_INDEX(unsigned long long, SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_DECL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
  KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_DECL_INDEX(unsigned long long, SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_INST_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
  KOKKOSBLAS1_IAMAX_ETI_SPEC_INST_INDEX(unsigned long long, SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_INST_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE) \
...
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_AVAIL(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                \
  ...
  KOKKOSBLAS1_IAMAX_ETI_SPEC_AVAIL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
...
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_AVAIL(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                     \
  ...
  KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_AVAIL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
...
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_DECL(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                \
  ...
  KOKKOSBLAS1_IAMAX_ETI_SPEC_DECL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
...
#define KOKKOSBLAS1_IAMAX_ETI_SPEC_INST(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                \
  ...
  KOKKOSBLAS1_IAMAX_ETI_SPEC_INST_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
...
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_DECL(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                \
  ...
  KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_DECL_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
...
#define KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_INST(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)                \
  ...
  KOKKOSBLAS1_IAMAX_MV_ETI_SPEC_INST_WIN64(SCALAR, LAYOUT, EXEC_SPACE, MEM_SPACE)
