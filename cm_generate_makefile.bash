...
# All the following options are not described in the help above
# for some reason...
KOKKOS_DO_TESTS=OFF
KOKKOS_DO_EXAMPLES=OFF
KOKKOSKERNELS_DO_TESTS=ON
KOKKOSKERNELS_DISABLE_BATCHED_TESTS=OFF
KOKKOSKERNELS_DISABLE_BLAS_TESTS=OFF
KOKKOSKERNELS_DISABLE_COMMON_TESTS=OFF
KOKKOSKERNELS_DISABLE_GRAPH_TESTS=OFF
KOKKOSKERNELS_DISABLE_SPARSE_TESTS=OFF
...
do
  ...
  case $key in
    ...
    --disable-tests)
      ...
      ;;
    --disable-batched-tests)
      KOKKOSKERNELS_DISABLE_BATCHED_TESTS=ON
      ;;
    --disable-blas-tests)
      KOKKOSKERNELS_DISABLE_BLAS_TESTS=ON
      ;;
    --disable-common-tests)
      KOKKOSKERNELS_DISABLE_COMMON_TESTS=ON
      ;;
    --disable-graph-tests)
      KOKKOSKERNELS_DISABLE_GRAPH_TESTS=ON
      ;;
    --disable-sparse-tests)
      KOKKOSKERNELS_DISABLE_SPARSE_TESTS=ON
      ;;
    --enable-examples)
      # This is the default
      KOKKOSKERNELS_DO_EXAMPLES=ON
...
echo ""
echo cmake $COMPILER_CMD -DKokkos_DIR="${KOKKOS_FIND_PATH}" -DCMAKE_CXX_FLAGS="${KOKKOS_CXXFLAGS}" -DCMAKE_INSTALL_PREFIX="${PREFIX}" -DKokkosKernels_ENABLE_TESTS=${KOKKOSKERNELS_DO_TESTS} -DKokkosKernels_DISABLE_BATCHED_TESTS=${KOKKOSKERNELS_DISABLE_BATCHED_TESTS} -DKokkosKernels_DISABLE_BLAS_TESTS=${KOKKOSKERNELS_DISABLE_BLAS_TESTS} -DKokkosKernels_DISABLE_COMMON_TESTS=${KOKKOSKERNELS_DISABLE_COMMON_TESTS} -DKokkosKernels_DISABLE_GRAPH_TESTS=${KOKKOSKERNELS_DISABLE_GRAPH_TESTS} -DKokkosKernels_DISABLE_SPARSE_TESTS=${KOKKOSKERNELS_DISABLE_SPARSE_TESTS} -DKokkosKernels_ENABLE_EXAMPLES:BOOL=${KOKKOSKERNELS_DO_EXAMPLES} ${KOKKOSKERNELS_SCALARS_CMD} ${KOKKOSKERNELS_ORDINALS_CMD} ${KOKKOSKERNELS_OFFSETS_CMD} ${KOKKOSKERNELS_LAYOUTS_CMD} ${KOKKOSKERNELS_TPLS_CMD} ${KOKKOSKERNELS_USER_TPL_PATH_CMD} ${KOKKOSKERNELS_USER_TPL_LIBNAME_CMD} ${KOKKOSKERNELS_EXTRA_LINKER_FLAGS_CMD} ${KOKKOSKERNELS_BUILDTYPE_CMD} ${KOKKOSKERNELS_SPACES_CMD} ${KERNELS_DEFAULT_ETI_OPTION} ${KOKKOSKERNELS_PATH}
echo ""
