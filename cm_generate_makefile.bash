...
if [ "$KOKKOSKERNELS_DEBUG" == "" ]; then
    KOKKOSKERNELS_DEBUG_CMD=-DCMAKE_BUILD_TYPE=RELEASE
else
    KOKKOSKERNELS_DEBUG_CMD=-DCMAKE_BUILD_TYPE=DEBUG
fi
...
if [ "${PREFIX}" == "" ]; then
  ...
  echo "KOKKOS_INSTALL_ PATH=$KOKKOS_INSTALL_PATH"
else
