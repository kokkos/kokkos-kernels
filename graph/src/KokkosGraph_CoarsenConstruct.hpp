 ...
 public:
  ...
  static coarse_level_triple build_coarse_graph_spgemm(coarsen_handle& handle, const coarse_level_triple level,
    ...
    if (handle.b == Spgemm_transpose_first) {
      ...
      KokkosSparse::spgemm_symbolic(&kh, nc, n, n, interp_transpose.graph.row_map,
      ...
      kh.create_spgemm_handle();
      KokkosSparse::spgemm_symbolic(&kh, nc, n, nc, row_map_p1, entries_p1, false,
      ...
      KokkosSparse::spgemm_numeric(&kh, nc, n, nc, row_map_p1, entries_p1, values_p1, false,
      ...
      kh.create_spgemm_handle();
      KokkosSparse::spgemm_symbolic(&kh, n, n, nc, g.graph.row_map, g.graph.entries, false,
                                                  interp_mtx.graph.row_map, interp_mtx.graph.entries, false,
                                                  row_map_p1);
      ...
      row_map_coarse = edge_view_t("rows_coarse", nc + 1);
      kh.create_spgemm_handle();
      KokkosSparse::spgemm_symbolic(&kh, nc, n, nc, interp_transpose.graph.row_map,
