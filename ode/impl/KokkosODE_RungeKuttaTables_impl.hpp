...
struct ButcherTableau<5, 7>  // Referred to as Verner 5-6 or VER56
{
  ...
  Kokkos::Array<double, nstages> b{{3.0 / 4.0, 0.0, 875.0 / 2244.0, 23.0 / 72.0, 264.0 / 1955.0, 0.0, 125.0 / 11592.0, 43.0 / 616.0}};
  Kokkos::Array<double, nstages> c{{0.0, 1.0 / 6.0, 4.0 / 15.0, 2.0 / 3.0, 5.0 / 6.0, 1.0, 1.0 / 15.0, 1.0}};
  Kokkos::Array<double, nstages> e{{3.0 / 4.0 - 13.0 / 160.0, 0.0, 875.0 / 2244.0 - 2375.0 / 5984.0, 23.0 / 72.0 - 5.0 / 16.0,
				      264.0 / 1955.0 - 12.0 / 85.0, -3.0 / 44.0, 125.0 / 11592.0, 43.0 / 616.0}};
};
