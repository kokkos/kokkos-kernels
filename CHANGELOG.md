...
example/gmres: Switch scalar to bhalf_t [\#1300](https://github.com/kokkos/kokkos-kernels/pull/1300)
...
unit_test/batched: Add Batched GEMM bhalf tests [\#1251](https://github.com/kokkos/kokkos-kernels/pull/1251)
