...
src_doc_mapping = dict([
                        ('batched/dense/src/KokkosBatched_ApplyHouseholder_Decl.hpp', ['batched_apply_householder.rst']),
                        ('batched/dense/src/KokkosBatched_Householder_Decl.hpp', ['batched_householder.rst']),
