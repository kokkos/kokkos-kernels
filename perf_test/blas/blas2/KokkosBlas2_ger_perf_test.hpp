...
#ifndef KOKKOSKERNELS_KOKKOSBLAS_GER_TEST_RPS_HPP
#define KOKKOSKERNELS_KOKKOSBLAS_GER_TEST_RPS_HPP
...
test_list construct_ger_kernel_base(const rajaperf::RunParams& run_params);
...
struct testData_ger {
  ...
  testData_ger(int m_in, int n_in, int repeat_in)
...
testData_ger<ExecSpace, Layout> setup_test(int m, int n, int repeat,
                                            bool layoutLeft);

#endif  // KOKKOSKERNELS_KOKKOSBLAS_GER_TEST_RPS_HPP
