...
#include <KokkosBlas2_gemv.hpp> // Aqui
#include <Kokkos_Random.hpp>

// Required for tracked_testing version
#include "KokkosBlas2_ger_perf_test.hpp"
...
testData_ger<ExecSpace, Layout> setup_test(int m, int n, int repeat) {
  testData_ger<ExecSpace, Layout> testData_ger_obj(m, n, repeat);

  return testData_ger_obj;
}
